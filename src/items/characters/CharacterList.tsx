  ...
  traces: {
      ...
      `,
        ...
        b1: {
            ...
            type: "bonus",
            level: "1/1",
            icon: charIcon("Firefly", "ModuleCoreOverload"),
            description: (i) => `
      ...
      `,
        ...
        b2: {
            ...
            type: "bonus",
            level: "1/1",
            icon: charIcon("Firefly", "ModuleAntilagOutburst"),
            description: (i) => `
      ...
      `,
        ...
        b3: {
            ...
            type: "bonus",
            level: "1/1",
            icon: charIcon("Firefly", "ModuleAutoreactiveArmor"),
            description: (i) => `
